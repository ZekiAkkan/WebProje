<%@ Page Title="" Language="C#" MasterPageFile="~/Anasayfa.Master" AutoEventWireup="true" CodeBehind="KadinHesapla.aspx.cs" Inherits="WebProje.KadinHesapla" %>
                ...
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                       ...
                       <asp:Label ID="Label1" runat="server" Text="Toplam vücut ağırlığı"></asp:Label>
                        ...
                        <br />
                        <br />
                        <asp:Label ID="Label8" Text="Bilek ölçüsü(cm)" runat="server"></asp:Label>
                        <asp:TextBox ID="TxtBilek" runat="server"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Label ID="Label9" Text="Kalça ölçüsü(cm)" runat="server"></asp:Label>
                        <asp:TextBox ID="TxtKalça" runat="server"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Label ID="Label10" Text="Ön kol ölçüsü(cm)" runat="server"></asp:Label>
                        <asp:TextBox ID="TxtÖnkol" runat="server"></asp:TextBox>
                        <br />
                        <br />
                        ...
                        <asp:Label ID="Label11" Text="Hanım," runat="server"></asp:Label>
                        <br />
